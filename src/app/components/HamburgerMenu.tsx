...
import {
  X, Home, User, Settings, Heart, HelpCircle,
  Info, FileText, Shield, Store, LogOut, Globe
} from 'lucide-react';
          ...
          >
              ...
              {isAuthenticated && user ? (
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 bg-[var(--brand-orange)] text-white py-2 rounded-xl font-semibold hover:bg-[var(--brand-orange-dark)] transition-colors"
                  >
                    {t('login')}
                  </button>
                  <button
            ...
            <div className="p-4">
              {menuItems.map((item, index) => (
                ...
                >
                  <item.icon size={22} className="text-[var(--text-secondary)]" />
